      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
        {recipes.slice(0, 12).map((recipe) => (
          <div key={recipe.id} className="bg-white shadow-lg rounded-lg p-4 transition-transform transform hover:scale-105 hover:shadow-xl">
            ...
            {/* Nutritional Info */}
            <p className="text-sm text-gray-600"><strong>Calories:</strong> {recipe.calories} kcal</p>
            <p className="text-sm text-gray-600"><strong>Carbs:</strong> {recipe.carbs}</p>
            <p className="text-sm text-gray-600"><strong>Fat:</strong> {recipe.fat}</p>
            <p className="text-sm text-gray-600"><strong>Protein:</strong> {recipe.protein}</p>
